...
namespace PaintIn3D
{
  ...
  public class P3dPaintableTexture : P3dLinkedBehaviour<P3dPaintableTexture>
  {
    ...
    public P3dSlot Slot { set { slot = value; } get { return slot; } }
    [SerializeField] private P3dSlot slot = new P3dSlot(0, "_MainTex");

    /// <summary>The UV channel this texture is mapped to.</summary>
    public P3dChannel Channel { set { channel = value; } get { return channel; } }
    [SerializeField] private P3dChannel channel;
    ...
    public StateType State { set { state = value; } get { return state; } }
    ...
    public int StateLimit { set { stateLimit = value; } get { return stateLimit; } }
    [SerializeField] private int stateLimit;
    ...
    public string SaveName { set { saveName = value; } get { return saveName; } }
    ...
    public string ShaderKeyword { set { shaderKeyword = value; } get { return shaderKeyword; } }
    [SerializeField] private string shaderKeyword;
    ...
    public MipType MipMaps { set { mipMaps = value; } get { return mipMaps; } }
    [SerializeField] private MipType mipMaps;
      ...
      if (activated == false)
      {
        ...
        if (material != null)
        {
          ...
          catch (System.Exception)
          {
            ...
            Debug.LogWarning($"Exception P3dPaintReplace.Blit(current, finalTexture, color)");
          }
      ...
      if (activated == true)
      {
        ...
        if (CommandsPending == true)
        {
          ...
          if (previewCommands.Count > 0)
          {
            ...
            if (preview.useMipMap == true) preview.GenerateMips();
          }
    ...
    private void ExecuteCommands(List<P3dCommand> commands, bool sendNotifications, ref RenderTexture main, ref RenderTexture swap, ref Mesh preparedMesh, ref Matrix4x4 preparedMatrix)
    {
      ...
      for (var i = 0; i < commands.Count; i++)
      {
        ...
        // Switch main and swap
        var temp = swap; swap = main; main = temp;
        ...
        else
        {
          ...
          Graphics.Blit(default(Texture), main, commandMaterial);
        }
